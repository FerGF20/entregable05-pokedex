...
const Pokemon = () => {
  ...
  const getPercenBarProgress = (valueStat) => {
    const maxValue = 150
        ...
        <section className='pokemonId'>
            ...
            <section className='pokemonId__info'>
                ...
                <div className='pokemonId__info-container'>
                    ...
                    <div className='pokemonId__info-data'>
                      {
                        dataPokemon?.abilities.map(ability => <p className='pokemonId_info-value' key={ability.ability.url}>{ability.ability.name}</p>)
                      }
                    </div>
                </div>
            </section>
                    ...
                    dataPokemon?.stats.map(stat => (
                      <div className='pokemonId__stat'>
                          ...
                          <div className='pokemonId__stat-bar'>
                              <div style={{width: getPercenBarProgress(stat.base_stat)}} className='pokemonId__stat-barProgress'></div>
                          </div>
                      </div>
                    ))
                  }
